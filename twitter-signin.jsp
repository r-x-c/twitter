  ...
  <div class="front-card">
    <div class="front-welcome">
      <div class="front-welcome-text">
        <h1>Welcome to Richard Chen's Twitter.</h1>
        <p>Find out what's happening, right now, with the people and organizations you care about.</p>
      </div>
    </div>

    <div class="front-signin">
      <form action="login.jsp" class="signin" method="get">
        <div class="placeholding-input username hasome">
          <input type="text" class="text-input email-input" name="username" title="Username or email" autocomplete="on" tabindex="1" placeholder="Username">
        </div>
    ...
    <div class="front-signup">
      ...
      <form action="insert_user.jsp" class="signup" method="get">
        <div class="fullname">
          <input type="text" id="signup-user-name" autocomplete="off" maxlength="30" name="username" placeholder="Username">
        </div>
        <div class="email">
          <input type="text" id="signup-user-email" autocomplete="off" maxlength="30" name="email" placeholder="Email">
        </div>
        <div class="password">
          <input type="password" id="signup-user-password" autocomplete="off" maxlength="30" name="password" placeholder="Password">
        </div>
